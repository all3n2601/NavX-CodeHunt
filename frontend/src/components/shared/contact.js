        ...
        <div class="mt-8 overflow-hidden">
          <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
              ...
              <ul class="list-disc text-normal text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-400 mt-2 px-8 py-2">
                <li>Refunds</li>
                <li>Misdemenaour</li>
                <li>Vehicle Conditioning</li>
                <li>Any Queries</li>
              </ul>

              <p class="text-normal text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-400 mt-2">
                Please do feel free to start a conversation
              </p>
              ...
              <div class="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                ...
                <div class="ml-4 text-md tracking-wide font-semibold w-40">
                  VIT-AP, Amaravati, Andhra Pradesh, 560049
                </div>
              </div>
            ...
            <form class="p-6 flex flex-col justify-center">
              ...
              <div class="flex flex-col mt-4">
                ...
                <input
                  ...
                  class="w-100 mt-2 py-8 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none"
                />
              </div>
