...
const Home = () => {
  return (
    <>
      <main className="container mx-auto py-8 h-[80%]">
        <section className="hero text-center">
          <h2 className="text-3xl font-bold mb-4">
            Share Rides, Save Money, Reduce Traffic
          </h2>
          <p className="text-gray-700 mb-4">
            NavX connects you with people traveling in the same direction,
            helping you save on transportation costs and reduce your carbon
            footprint.
          </p>
          <Link
            to="/signup"
          ...
          <div className="flex justify-around">
            <div className="max-w-xs">
              <div className="bg-white shadow-md rounded-lg p-6 mb-4">
                ...
                <p>
                  Enter your destination and view available rides going your
                  way.
                </p>
              </div>
            </div>
            <div className="max-w-xs">
              <div className="bg-white shadow-md rounded-lg p-6 mb-4">
                ...
                <p>
                  Join an existing ride or offer a seat in your vehicle to
                  others.
                </p>
              </div>
            </div>
            <div className="max-w-xs">
              <div className="bg-white shadow-md rounded-lg p-6 mb-4">
                ...
                <p>
                  Share the journey with others and contribute to a greener
                  environment.
                </p>
              </div>
            </div>
